...
var Menu = function () {
    ...
    return (react_1.default.createElement("aside", { id: "layout-menu", className: "layout-menu menu-vertical menu bg-menu-theme" },
        ...
        react_1.default.createElement("ul", { className: "menu-inner py-1" },
            ...
            privacies.map(function (element, index) {
                return element.menu !== false ? (react_1.default.createElement("li", { className: "menu-item ".concat(pathname === element.path && 'active', " ").concat(open === element.path && 'open'), key: index }, element.children ? (react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    react_1.default.createElement("i", { className: "menu-icon tf-icons bx ".concat(element.icon) }),
                    react_1.default.createElement("div", null, t(element.name)))))) : null;
            }),
            ...
            generics.map(function (element, index) {
                return element.menu !== false ? (react_1.default.createElement("li", { className: "menu-item ".concat(pathname.match(element.path) && 'active', " ").concat(open === element.path && 'open'), key: index }, element.children ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("a", { className: "menu-link menu-toggle cursor-pointer", onClick: function () {
                            return setOpen(open !== element.path ? element.path : '');
                        } },
                        react_1.default.createElement("i", { className: "menu-icon tf-icons bx ".concat(element.icon) }),
                        react_1.default.createElement("div", null, t(element.name))),
                    react_1.default.createElement("ul", { className: "menu-sub" }, element.children.map(function (child) { return (react_1.default.createElement("li", { className: "menu-item ".concat(pathname ===
                            "".concat(element.path).concat(child.path) &&
                            'active') },
                        react_1.default.createElement(react_router_dom_1.Link, { to: "".concat(element.path).concat(child.path), className: "menu-link" },
                            react_1.default.createElement("div", null, t(child.name))))); })))) : (react_1.default.createElement(react_router_dom_1.Link, { to: element.path, className: "menu-link" },
                    react_1.default.createElement("i", { className: "menu-icon tf-icons bx ".concat(element.icon) }),
