...
var Input = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "mb-3" },
        ...
        react_1.default.createElement("input", { id: name, type: type, name: name, autoFocus: focus, defaultValue: value, onChange: handleChange, className: "form-control", placeholder: t(placeholder) })));
};
exports.Input = Input;
