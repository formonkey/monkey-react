...
var GenericView = function (props) {
    ...
    return props.config ? (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("div", { className: "card" },
            props.filters && ((_a = props.filters.fields) === null || _a === void 0 ? void 0 : _a.length) > 1 && (react_1.default.createElement("div", { className: "card-header border-bottom row row ms-2 me-3 p-4" },
                react_1.default.createElement("h5", { className: "card-title" }, t((_b = props.filters.title) !== null && _b !== void 0 ? _b : 'Search Filters')),
                react_1.default.createElement("div", { className: "pr-2" },
                    ...
                    ","))),
            react_1.default.createElement(table_1.Table, { data: data, meta: meta, queries: queries, form: props.form, config: props.config, filters: props.filters, actions: props.actions, refresh: function (searches) {
                    var _a;
                    if (searches === void 0) { searches = "".concat(queries.pagination.page, "=").concat(queries.system === 'eve' ? 1 : 0, "&").concat(queries.pagination.limit, "=").concat(queries.limit); }
                    return api("".concat(props.config.endpoint, "?").concat(searches, "&").concat((_a = props.config.query) !== null && _a !== void 0 ? _a : ''), 'GET');
