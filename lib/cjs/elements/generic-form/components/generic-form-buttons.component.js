...
var GenericFormButtons = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, !config.multiple || step + 1 === config.fields.length ? (react_1.default.createElement("div", { className: "g-2" },
        config.multiple && step > 0 ? (react_1.default.createElement("button", { type: "button", className: "btn m-2 btn-label-secondary", "data-bs-dismiss": "modal", onClick: onStep }, t('Previous Step'))) : (react_1.default.createElement("button", { type: "button", className: "btn m-2 btn-label-secondary", "data-bs-dismiss": "modal", onClick: close }, t('Cancel'))),
