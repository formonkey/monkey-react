...
var GenericForm = function (_a) {
    ...
    var _c = (0, monkey_conf_1.useMonkeyConf)(), token = _c.token, queries = _c.queries;
    var _d = (0, react_1.useState)(0), step = _d[0], setStep = _d[1];
    var _e = (0, react_1.useState)(values), form = _e[0], setForm = _e[1];
    var _f = (0, http_client_1.useHttpClient)(), api = _f.api, state = _f.state;
    var _g = (0, react_1.useState)([]), fields = _g[0], setFields = _g[1];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, constants_1.GENERIC_FORM_CONFIG_PARSED.REQUEST(get, field, token)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2:
    ...
    return (react_1.default.createElement("div", { className: "row fv-plugins-bootstrap5 fv-plugins-framework" },
        fields.map(function (item, index) { return (react_1.default.createElement("div", { className: "col-12 col-md-".concat(item.row), key: index }, constants_1.GENERIC_FORM_ELEMENTS[item.element] ? (constants_1.GENERIC_FORM_ELEMENTS[item.element](__assign(__assign({}, item), { t: t, onChange: onChange, form: __assign({}, form), value: form[item.name] || (values === null || values === void 0 ? void 0 : values[item.name]) }))) : (react_1.default.createElement(react_1.default.Fragment, null)))); }),
        !isFilter && (react_1.default.createElement(components_1.GenericFormButtons, { t: t, step: step, close: close, config: config, onStep: onStep, onSubmit: onSubmit }))));
};
