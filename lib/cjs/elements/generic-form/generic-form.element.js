...
var GenericForm = function (_a) {
    ...
    var _b = (0, monkey_conf_1.useMonkeyConf)(), token = _b.token, queries = _b.queries;
    var _c = (0, react_1.useState)(0), step = _c[0], setStep = _c[1];
    var _d = (0, react_1.useState)({}), form = _d[0], setForm = _d[1];
    var _e = (0, http_client_1.useHttpClient)(), api = _e.api, state = _e.state;
    var _f = (0, react_1.useState)([]), fields = _f[0], setFields = _f[1];
