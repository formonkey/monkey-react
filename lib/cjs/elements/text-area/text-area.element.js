...
var TextArea = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "mb-3" },
        ...
        react_1.default.createElement("textarea", { rows: 3, id: name, name: name, value: form === null || form === void 0 ? void 0 : form[name], onChange: handleChange, className: "form-control", placeholder: t(placeholder) })));
};
