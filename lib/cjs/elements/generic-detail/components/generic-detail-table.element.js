                ...
                react_1.default.createElement("div", { className: "d-flex justify-content-between align-items-center flex-column flex-sm-row mx-4 row" },
                    ...
                    react_1.default.createElement("div", { className: "col-sm-8 col-12 d-flex align-items-center justify-content-sm-end justify-content-center" },
                        ...
                        react_1.default.createElement("div", { className: "dt-buttons" },
                            ' ',
                            react_1.default.createElement("button", { className: "dt-button add-new btn btn-primary mx-3", tabIndex: 0, "aria-controls": "DataTables_Table_0", type: "button", "data-bs-toggle": "offcanvas", "data-bs-target": "#offcanvasAddUser" },
                                react_1.default.createElement("span", null,
                                    react_1.default.createElement("i", { className: "bx bx-plus me-0 me-sm-2" }),
                                    react_1.default.createElement("span", { className: "d-none d-lg-inline-block" },
                                        "Add ",
                                        item.label))),
                            ' '))),
