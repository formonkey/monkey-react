    ...
    return (React.createElement("li", { className: "nav-item navbar-dropdown dropdown-user dropdown" },
        React.createElement("a", { className: "nav-link dropdown-toggle hide-arrow", href: "javascript:void(0);", "data-bs-toggle": "dropdown" },
            React.createElement("div", { className: "avatar avatar-online" },
                React.createElement("img", { src: "https://www.getbillage.com/files/user/avatar/_usuario.png", alt: "", className: "w-px-40 h-auto rounded-circle" }))),
                ...
                React.createElement("a", { className: "dropdown-item", href: "pages-account-settings-account.html" },
                    React.createElement("div", { className: "d-flex" },
                        ...
                        React.createElement("div", { className: "flex-grow-1" },
                            ...
                            React.createElement("small", { className: "text-muted" }, ((_a = data.roles) === null || _a === void 0 ? void 0 : _a.indexOf("admin")) >= 0
                                ? "Admin"
                                : "User"))))),
            React.createElement("li", null,
