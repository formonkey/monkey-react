...
export var GenericView = function (props) {
    ...
    var _c = useState({}), meta = _c[0], setMeta = _c[1];
    ...
    return props.config ? (React.createElement("div", null,
        ...
        React.createElement("div", { className: "card" },
            props.filters && (React.createElement("div", { className: "card-header border-bottom row row ms-2 me-3 p-4" },
                React.createElement("h5", { className: "card-title" }, t((_a = props.filters.title) !== null && _a !== void 0 ? _a : 'Search Filters')),
