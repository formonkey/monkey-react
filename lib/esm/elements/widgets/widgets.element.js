...
export var Widgets = function (_a) {
    ...
    return (React.createElement("div", { className: "row" }, isReady
        ? classNames === null || classNames === void 0 ? void 0 : classNames.map(function (className, idx) {
            var _a;
            return (React.createElement("div", { key: idx, className: className }, (_a = widgets[idx]) === null || _a === void 0 ? void 0 : _a.map(function (widget) { var _a; return (_a = WIDGET_ELEMENTS === null || WIDGET_ELEMENTS === void 0 ? void 0 : WIDGET_ELEMENTS[widget.element]) === null || _a === void 0 ? void 0 : _a.call(WIDGET_ELEMENTS, { conf: widget, idx: idx, t: t }); })));
        })
        : null));
};
