...
export var Role = function (_a) {
    ...
    var handleChange = function (e, option) {
        var _a;
        value = value || [];
        var temp = __spreadArray(__spreadArray([], value, true), e.target.value.split(','), true).filter(function (key) {
            return option.remove.indexOf(key);
        });
        onChange((_a = {}, _a[name] = temp, _a));
    };
