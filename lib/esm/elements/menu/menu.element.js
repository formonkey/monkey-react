    ...
    return (React.createElement("aside", { id: "layout-menu", className: "layout-menu menu-vertical menu bg-menu-theme" },
        ...
        React.createElement("ul", { className: "menu-inner py-1" },
            ...
            privacies.map(function (element, index) {
                return element.menu !== false ? (React.createElement("li", { className: "menu-item ".concat(pathname === element.path && 'active', " ").concat(open === element.path && 'open'), key: index }, element.children ? (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("i", { className: "menu-icon tf-icons bx ".concat(element.icon) }),
                    React.createElement("div", null, t(element.name)))))) : null;
            }),
            ...
            generics.map(function (element, index) {
                return element.menu !== false ? (React.createElement("li", { className: "menu-item ".concat(pathname.match(element.path) && 'active', " ").concat(open === element.path && 'open'), key: index }, element.children ? (React.createElement(React.Fragment, null,
                    React.createElement("a", { className: "menu-link menu-toggle cursor-pointer", onClick: function () {
                            return setOpen(open !== element.path ? element.path : '');
                        } },
                        React.createElement("i", { className: "menu-icon tf-icons bx ".concat(element.icon) }),
                        React.createElement("div", null, t(element.name))),
                    React.createElement("ul", { className: "menu-sub" }, element.children.map(function (child) { return (React.createElement("li", { className: "menu-item ".concat(pathname ===
