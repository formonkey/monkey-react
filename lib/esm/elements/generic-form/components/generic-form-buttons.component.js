...
export var GenericFormButtons = function (_a) {
    ...
    return (React.createElement(React.Fragment, null, !config.multiple || step + 1 === config.fields.length ? (React.createElement("div", { className: "g-2" },
        config.multiple && step > 0 ? (React.createElement("button", { type: "button", className: "btn m-2 btn-label-secondary", "data-bs-dismiss": "modal", onClick: onStep }, t('Previous Step'))) : (React.createElement("button", { type: "button", className: "btn m-2 btn-label-secondary", "data-bs-dismiss": "modal", onClick: close }, t('Cancel'))),
